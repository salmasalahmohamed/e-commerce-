    ...
    <div class="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto bg-white border rounded-md dark:border-gray-900 dark:bg-gray-900 md:py-10 md:px-10">
        <div>
                ...
                <div class="flex items-start justify-start flex-shrink-0">
                    <div class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start">
                        <div class="flex flex-col items-start justify-start space-y-2">
                            ...
                            <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">{{$order->address->city}},{{$order->address->state}}</p>
            ...
            <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200 dark:border-gray-700">
                ...
                <div class="w-full px-4 mb-4 md:w-1/4">
                    ...
                    <p class="text-base font-semibold leading-4 text-blue-600 dark:text-gray-400">
                        {{\Illuminate\Support\Number::currency($order->grand_total??0,'EGP')}}</p>
                </div>
                <div class="w-full px-4 mb-4 md:w-1/4">
                    <p class="mb-2 text-sm leading-5 text-gray-600 dark:text-gray-400 ">
                        Payment Method: </p>
                    ...
                    <div class="flex flex-col w-full space-y-6 ">
                        ...
                        <div class="flex flex-col items-center justify-center w-full pb-4 space-y-4 border-b border-gray-200 dark:border-gray-700">
                            <div class="flex justify-between w-full">
                                ...
                                <p class="text-base leading-4 text-gray-600 dark:text-gray-400">{{\Illuminate\Support\Number::currency($order->grand_total??0,'EGP')}}</p>

                            </div>
                            <div class="flex items-center justify-between w-full">
                                <p class="text-base leading-4 text-gray-800 dark:text-gray-400">Discount
                                </p>
                                <p class="text-base leading-4 text-gray-600 dark:text-gray-400">                        {{\Illuminate\Support\Number::currency(0,'EGP')}}</p>
                            </div>
                            <div class="flex items-center justify-between w-full">
                        ...
                        <div class="flex items-center justify-between w-full">
                            ...
                            <p class="text-base font-semibold leading-4 text-gray-600 dark:text-gray-400">                        {{\Illuminate\Support\Number::currency($order->grand_total??0,'EGP')}}</p>
            ...
            <div class="flex items-center justify-start gap-4 px-4 mt-6 ">
                ...
                <a href="{{url('/my-orders')}}" class="w-full text-center px-4 py-2 bg-blue-500 rounded-md text-gray-50 md:w-auto dark:text-gray-300 hover:bg-blue-600 dark:hover:bg-gray-700 dark:bg-gray-800">
                    View My Orders
                </a>
            </div>
        </div>
