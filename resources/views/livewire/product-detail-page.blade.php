                ...
                <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: {{url('/storage/'.$product->image[0])}} }">
                    <div class="sticky top-0 z-50 overflow-hidden ">
                        ...
                        <div class="flex-wrap hidden md:flex ">
                            ...
                            <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage={{url('storage/'.$img)}}">
                                <img src="{{url('storage/'.$img)}}" alt="" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500">
                            </div>
                    ...
                    <div class="lg:pl-20">
                        <div class="mb-8 ">
                            ...
                            <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                                <span>${{ \Illuminate\Support\Number::currency($product->price,'EGP')}}</span>
                            </p>
                        ...
                        <div class="w-32 mb-8 ">
                            <label for="" class="w-full pb-1 text-xl font-semibold text-gray-700 border-b border-blue-300 dark:border-gray-600 dark:text-gray-400">{{$product->is_stock?'in stock':'not in stock'}}</label>
