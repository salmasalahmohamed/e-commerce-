                ...
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                        ...
                        <ul>
                            ...
                            <li class="mb-4">
                                <label for="" class="flex items-center dark:text-gray-400 ">
                                    <input   wire:model.live="filterByCategory"  value="{{$category->id}}" type="checkbox" class="w-4 h-4 mr-2" >
                        ...
                        <ul>
                            ...
                            <li class="mb-4">
                                <label for="" class="flex items-center dark:text-gray-300">
                                    <input type="checkbox"  wire:model.live="filterByBrand"  value="{{$brand->id}}" class="w-4 h-4 mr-2">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <ul>
                            <li class="mb-4">
                                <label for="" class="flex items-center dark:text-gray-300">
                                    <input wire:model.live="filterByStock" value="1" type="checkbox" class="w-4 h-4 mr-2">
                                    <span class="text-lg dark:text-gray-400">In Stock</span>
                                </label>
                            </li>
                            <li class="mb-4">
                                <label for="" class="flex items-center dark:text-gray-300">
                                    <input   wire:model.live="filterBySale"  value="1" type="checkbox" class="w-4 h-4 mr-2">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div>
                            ...
                            <input type="range"  wire:model.live="price"
                                   min="100"
                                   max="500000"
                                   class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer"  step="100000">
                            <div class="flex justify-between ">
                                <span class="inline-block text-lg font-bold text-blue-400 ">&#8377; 100</span>
                ...
                <div class="w-full px-3 lg:w-3/4">
                    <div class="px-3 mb-4">
                        <div class="items-center justify-between hidden px-3 py-2 bg-gray-100 md:flex dark:bg-gray-900 ">
                            <div wire:model.live="sort" class="flex items-center justify-between">
                            ...
                            <div class="border border-gray-300 dark:border-gray-700">
                                <div class="relative bg-gray-200">
                                    <a href="{{url('product/'.$product->slug)}}" class="">
                                        <img src="{{asset('storage/'.$product->image[0])}}" alt="" class="object-cover w-full h-56 mx-auto ">
                                    </a>
                                </div>
                                <div class="p-3 ">
